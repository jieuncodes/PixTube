...
export const postJoin = async (req, res) => {
  ...
  if (!picFile) {
    picFile = {
      location:
        "https://pixtube.s3.ap-northeast-2.amazonaws.com/default_avatar.webp",
    };
    noAvatar = true;
  }
...
export const postEdit = async (req, res) => {
  ...
  if (errorMessageArray.length > 0) {
    return res
      .status(400)
      .render("user/edit", { pageTitle, errorMessage: errorMessageArray });
  } else if (
    ...
    return res
      .status(400)
      .render("user/edit", { pageTitle, errorMessage: "Nothing has changed." });
  }
